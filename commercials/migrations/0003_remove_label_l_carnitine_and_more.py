...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('commercials', '0002_remove_label_category_label_categories_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nutrient', models.CharField(blank=True, max_length=200, null=True)),
                ('label', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='commercials.label')),
                ('unit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='unit', to='commercials.unit')),
            ],
        ),
    ]
